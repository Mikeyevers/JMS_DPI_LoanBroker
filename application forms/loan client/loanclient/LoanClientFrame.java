...
public class LoanClientFrame extends JFrame {
    ...
    public LoanClientFrame() {
        ...
        btnQueue.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                rr.setCorrelationId(UUID.randomUUID().toString());

                listModel.addElement(rr);
                loanBrokerAppGateway.applyForLoan(request, rr.getCorrelationId());
            }
        });
    ...
    public void addReply(LoanReply loanReply, String correlationId) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    loanBrokerAppGateway = new LoanBrokerAppGateway(frame);
